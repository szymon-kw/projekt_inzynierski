...
public class SummaryController {
    ...
    public SummaryController(ReportService reportService, TemplateEngine templateEngine, UserRepository userRepository, UserManagementService userManagementService, ChartService chartService) {
    ...
    public void generateSummary(
        ...
        context.setVariable("categories", categoryName);
